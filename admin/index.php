...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            $didapproved_comment_count = mysqli_num_rows($select_all_disapproved_comments);
            ...
            <script type="text/javascript">
                ...
                function drawChart() {
                    var data = google.visualization.arrayToDataTable([
                        ...
                        $elements_text = ['All Posts', 'Published posts', 'Draft posts', 'Comments', 'Approved comments', 'Unapproved comments', 'Users', 'Categories'];
